...
```{r timebox}
style_opts <- list("size_min" = 1, "size_max" = 10)
timebox_tree(time_data, edges, height = 250, width = 300, style_opts)
```

```{r treebox}
treebox(time_data, edges, height = 250, width = 300, style_opts)
```
...
```{r timebox-means}
style_opts$size_min <- 0.5
timebox_tree(time_data, edges, style_opts = style_opts)
```

```{r treebox-means}
treebox(time_data, edges, style_opts = style_opts)
```
