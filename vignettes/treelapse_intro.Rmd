...
* we  use the [HTMLWidgets](http://www.htmlwidgets.org/)
package to connect data manipulation in R and with data visualization in d3.
* we are using timeboxes, doi trees, and (sort of) treeversity
